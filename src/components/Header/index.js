...
const Header = () => {
  ...
  return (
    <nav
      className={`${
        scrolled ? 'fixed top-0 left-0 w-full z-10 shadow-md' : 'col-span-10 shadow-none'
      } transition-shadow duration-200 ease-in-out flex  items-center justify-between border-0 xl:grid xl:grid-cols-10 gap-1 bg-primary-light dark:bg-gray-900 py-6`}
    >
