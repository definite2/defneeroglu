...
const AlertDialog = ({ handleClose, title, message, success }) => {
  return (
    <Backdrop onClick={handleClose}>
      <div className="items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center block sm:p-0">
        ...
        <motion.div
          ...
          className={`inline-block align-bottom bg-primary-light dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full`}
