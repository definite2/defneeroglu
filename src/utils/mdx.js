...
import remarkCodeTitles from '../plugins/remarkCodeTitles'
...
export async function getAllFilesFrontMatter(folder) {
  ...
  files.forEach((file) => {
    ...
    if (!frontmatter.draft) {
      allFrontMatters.push({ ...frontmatter, slug: formatSlug(filename),lastmod: frontmatter.lastmod ? new Date(frontmatter.lastmod).toISOString() : null, })
    }
  })
