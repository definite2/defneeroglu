  ...
  return (
    <article className="h-full">
      <CustomLink href={`/blog/${slug}`} className="text-gray-800 dark:text-gray-100">
        <div className="flex flex-col items-center justify-between h-full overflow-hidden cursor-pointer border-2 border-gray-150  dark:border-gray-800 rounded-lg">
          {image && (
          ...
          <section className="flex flex-col h-full px-5 pb-5 pt-1">
