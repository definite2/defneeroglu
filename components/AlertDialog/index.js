...
// framer-motion accept direct children or custom forwarded components
export const AlertDialog = ({ showAlert, handleClose, message, title, success }) => (
        ...
        >
          <div className="bg-primary-grayish dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div
                className={`m-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full ${success ? 'bg-primary-100' : 'bg-red-100'
