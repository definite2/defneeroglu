...
Our app componnet will be consist of Login component and ErrorPortal component, as mentioned before the place of ErrorPortal is not important we we would have more than one component such as routes here still we put our ErrorPortal just next to the most parent component inside of the App component.
...
In this post I tried to show how you can use axios interceptors to get network level data to write the data to your application's redux store and create react portal component.
I could have covered these two topics under different blogs, but I wanted to cover them in a single article, since these two are combined in this way in real React projects. I hope this could help you.
