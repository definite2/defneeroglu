...
<p>
  ...
  [LabelMe](http://labelme.csail.mit.edu/guidelines.html). LabelMe is written in python and it is
  more like a desktop application.
</p>

<p>
  In this blog I am going to use a minimal react app to draw polygon shapes to configure the
  coordinates of the object or the area.
</p>
<p>
  To perform drawing on images we need canvas object, for this I used Konva.js. It is an open source
