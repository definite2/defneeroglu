...
```
### Conclusion
With this post I want to show that you should not think that react hooks are for your shared logic, instead we can use this fact for managing UI states of our application such as showing a sticky header or showing a scroll to top icon etc. 